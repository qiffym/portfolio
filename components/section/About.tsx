        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            <div className="flex items-center gap-1">
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/in/qiff-ya-muhammad-710a06191/"
                target="_blank"
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/qiffym_/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <button className="btn-outline btn-primary btn-circle btn">
              ...
              {/* Twitter */}
              <a
                href="https://www.twitter.com/qiffym_/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <button className="btn-outline btn-primary btn-circle btn">
              ...
              {/* GitHub */}
              <a
                href="https://www.github.com/qiffym/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <button className="btn-outline btn-primary btn-circle btn">
